...
export const searchService = {
  ...
  search:
    'https://www.metawarehouse.apps.be.ch/rpc/oereb_search?searchtext={{query}}',
...
export const externalInstructions = {
  instructionUrl: //false,
	'https://oerebfiles.apps.be.ch/docs/oereb/oerebviewer/ÖREBK_BE_ÖREB_Viewer_Benutzeranleitung_{{languageUppercase}}.pdf', // url to external instruciton - place holder {{language}} and {{languageUppercase}} - disabled if false
}
