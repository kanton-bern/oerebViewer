...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css?family=Asap:400,700&display=swap"}],"style":[],"script":[],"noscript":[],"title":"ÖREB-Viewer | Visualiseur RDPPF","htmlAttrs":{"lang":"de"}};
